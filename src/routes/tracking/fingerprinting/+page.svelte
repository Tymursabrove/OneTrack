			...
			<div class="xl:col-span-8">
				<div class="space-y-6 flex-1 xl:max-w-2xl">
					...
					<div class="flex justify-between gap-5">
						<p class="text-lg leading-none">Activate Fingerprinting</p>
						<div class="relative">
							<CheckBox
		...
		<div class="flex flex-col xl:grid xl:grid-cols-20 gap-5 flex-1">
			...
			<div class="xl:col-span-12 flex-1 flex items-start justify-end">
				<div class="overflw-hidden relative xl:-mr-8">
					<img src="/images/fingerprinting.png" alt="" class="opacity-0 invisible" />
					{#if after}
						<div class="absolute inset-0" transition:fade>
							<img src="/images/fingerprinting-on.png" alt="" />
						</div>
					{:else}
						<div class="absolute inset-0" transition:fade>
							<img src="/images/fingerprinting.png" alt="" />
						</div>
					{/if}
				</div>
			</div>
